...
4. **Next.js security advisories:** Pin Next to a patched 15.x line and re-run `npm audit` after scaffold. **CVE-2025-66478:** Vercel blocks new deployments on vulnerable Next.js builds; the 15.2.x line must be at least **15.2.8** (see [Next.js security advisory](https://nextjs.org/blog/CVE-2025-66478)). After upgrading production, rotate secrets (`NEXTAUTH_SECRET`, etc.) per advisory guidance.
